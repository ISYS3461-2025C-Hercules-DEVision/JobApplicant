package com.example.application.application.kafka;

import com.example.application.application.config.KafkaConstant;
...
public class KafkaConsumerConf {
    ...
    public ConsumerFactory<String, String> defaultConsumerFactory() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, KafkaConstant.APPLICATION_GROUP_ID);
