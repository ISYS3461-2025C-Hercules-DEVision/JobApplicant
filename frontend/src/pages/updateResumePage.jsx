...
//     const minSalary = formData.minSalary === "" ? null : String(formData.minSalary);
//     const maxSalary = formData.maxSalary === "" ? null : String(formData.maxSalary);
//
//     return {
//       ...formData,
...
//           fromYear: e.fromYear === "" || e.fromYear === null ? null : Number(e.fromYear),
...
//     try {
//       setLoading(true);
//       await onSubmitResume?.(parsed.data);
//       setSuccess(true);
//     } catch (err) {
...
//
//   // -----------------------------
//   // Media upload handlers (optional: you can also validate with uploadMediaSchema)
//   // -----------------------------
...
//           <div>
//             <h1 className="text-4xl font-black text-black uppercase">Update Resume</h1>
//             <p className="text-gray-600 font-semibold mt-2">
//               Fill in your profile and resume details. This will be shown to employers.
//             </p>
//           </div>
//
//           <button
...
//               <h2 className="text-xl font-black uppercase text-gray-700">Education</h2>
//               <button
//                 type="button"
//                 onClick={() =>
...
//                       value={edu.fromYear ?? ""}
//                       onChange={(e) => updateArrayItem("education", idx, "fromYear", e.target.value)}
//                       disabled={loading}
//                       className="w-full px-4 py-3 border-4 border-black font-bold uppercase focus:outline-none focus:ring-4 focus:ring-primary"
//                     />
//
...
//                       value={edu.toYear ?? ""}
//                       onChange={(e) => updateArrayItem("education", idx, "toYear", e.target.value)}
//                       disabled={loading}
//                       className="w-full px-4 py-3 border-4 border-black font-bold uppercase focus:outline-none focus:ring-4 focus:ring-primary"
//                     />
//
...
//           <section className="space-y-4">
//             <div className="flex items-center justify-between gap-4 border-b-4 border-black pb-2">
//               <h2 className="text-xl font-black uppercase text-gray-700">Work Experience</h2>
//               <button
//                 type="button"
//                 onClick={() =>
...
//                       onChange={(e) =>
//                         updateArrayItem("experience", idx, "companyName", e.target.value)
//                       }
//                       disabled={loading}
//                       className="w-full px-4 py-3 border-4 border-black font-bold uppercase focus:outline-none focus:ring-4 focus:ring-primary"
//                     />
...
//                       value={exp.fromYear || ""}
//                       onChange={(e) => updateArrayItem("experience", idx, "fromYear", e.target.value)}
//                       disabled={loading}
//                       className="w-full px-4 py-3 border-4 border-black font-bold uppercase focus:outline-none focus:ring-4 focus:ring-primary"
//                     />
//
...
//                       value={exp.toYear || ""}
//                       onChange={(e) => updateArrayItem("experience", idx, "toYear", e.target.value)}
//                       disabled={loading}
//                       className="w-full px-4 py-3 border-4 border-black font-bold uppercase focus:outline-none focus:ring-4 focus:ring-primary"
//                     />
//                   </div>
...
//           <section className="space-y-4">
//             <div className="flex items-center justify-between gap-4 border-b-4 border-black pb-2">
//               <h2 className="text-xl font-black uppercase text-gray-700">Media Portfolios</h2>
//
//               <button
//                 type="button"
...
//                     <p className="font-black uppercase truncate">{m.title || "Untitled Media"}</p>
