    ...
    <div>
      ...
      <div className="min-h-screen bg-light-gray flex items-center justify-center p-4">
        <div className="bg-white border-4 border-black p-10 w-full max-w-md shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
          <h1 className="text-4xl font-black text-center text-black mb-8 uppercase">Get started now!</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full bg-primary text-white font-black py-4 border-4 border-black uppercase hover:translate-x-1 hover:translate-y-1 hover:shadow-none shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-none flex items-center justify-center gap-2"
            >
              {step < 3 ? 'Create Profile' : 'Complete'}
          ...
          <div className="flex justify-center items-center gap-4 mt-8">
            <div className={`w-14 h-14 flex items-center justify-center border-4 border-black font-black text-xl ${
          ...
          <p className="text-center mt-6 text-black font-bold uppercase text-sm">
            ...
            <Link to="/login" className="text-primary font-black underline underline-offset-4 decoration-4">
              Log in
            </Link>
          </p>
        </div>
